...
- If the custom broker token may be exposed, run `npx --yes @mrketa/potassium-mcp@0.10.0-beta.3 rotate-token`, then restart or reload affected MCP hosts and reattach Potassium. **Repair preserves a valid token and is not credential rotation.**
