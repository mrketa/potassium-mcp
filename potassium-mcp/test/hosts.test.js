...
import { createInstallPlan, inspectHost, removeConfig, resolveHost, transformConfig, verifyOwnership } from "../src/hosts.js";

const cwd = "C:\\work\\project";
const env = { USERPROFILE: "C:\\Users\\Ada", APPDATA: "C:\\Users\\Ada\\AppData\\Roaming" };
const launcher = { type: "stdio", command: "C:\\Program Files\\nodejs\\node.exe", args: ["C:\\npm\\potassium-mcp\\bin\\potassium-mcp.js", "serve", "--config", "C:\\Potassium\\MCP\\config.json", "--host-id", "project-a"], timeout: 40000 };
